...
extends JPanel
{
	 ...
	 * @uml.associationEnd  inverse="gamePanel:aSimpleGamev0p5p0.Word"
	 */
	...
	public Word checkLocation(int x,int y)
	{
		...
		for(int i=0;i<words.length;i++)
		{
			...
			if((x > pX-(4) && x < pX+((l*3)+20)) && (y > pY-11 && y < pY+4)) //Tolerance = x: -4 to (length of the word*3)+20 because it fits well.  y: -11 to +4 (10pt = 13px). 13+2 to give a little lee way.
			{
