...
public class LoadDriver
{
	 ...
	 * @param t The type to take (currently: "game", "editorNew", "editorExisting" and "image").
	 * 
	 * @see ApplicationDriver
	 * @see LoadFrame
	 */
	...
	/**
	 * Added id to allow a link back to 
	 * @param a
	 * @param t
	 * @param i
	 */
	public LoadDriver(WordPanel w,String t)
	{
		wordPanel = w;
		type = t;
		loadFrame = new LoadFrame(this);
	...
	public void loadRoutine(String file)
	{
		...
		{
			loadFrame.setOnTop();
			if(this.testFileIsImage(file))
			{
				System.out.println(file);
				wordPanel.setImageFile(file);
			}
		}
	...
	public boolean testFileIsImage(String file)
	{
		//if it passes all tests return true
		if(testFileExtensionImage(file))
		{
			return true;
		}
		//else return false
	 ...
	 * @see ErrorFrame
	 */
	public boolean testFileExtensionImage(String file)
	{
		//Ready the Error Frame
		ErrorFrame errorFrame;
		...
		{
			errorFrame = new ErrorFrame("Error 01 - '"+file+"' uses an incorrect image file extension.");
			errorFrame.showFrame();
			return false;
		}
		//Else show the relevant error message and return false.
	...
	public boolean testFileExists(String file)
	{
		...
		{
			errorFrame = new ErrorFrame("Error 05 - Unknown exception whilst loading '"+file+"', Error "+e);
			errorFrame.showFrame();
			return false;
		}
	}
