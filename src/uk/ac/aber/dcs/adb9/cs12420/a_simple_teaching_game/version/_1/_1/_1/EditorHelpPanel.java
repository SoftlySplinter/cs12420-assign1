...
public class EditorHelpPanel extends SimplePanel
{
	...
	private final String MAIN = new String("<html>			<p>&nbsp;</p>	<p>Welcome to the A Simple Game Help.</p>															<p>&nbsp;</p>	<p>Please select an option from the list to the left to view more detailed help</p>					<p>&nbsp;</p>	</html>");

	private final String TARGET_WORD = new String("<html>	<p>&nbsp;</p>	<p>This is the Word the player has to click on to win the game.</p>									<p>&nbsp;</p>	<p>&nbsp;</p>																						<p>&nbsp;</p>	</html>");
	
	private final String OTHER_WORD = new String("<html>	<p>&nbsp;</p>	<p>These are the other Words the player must avoid. Will show a bad message when clicked on.</p>	<p>&nbsp;</p>	<p>&nbsp;</p>																						<p>&nbsp;</p>	</html>");
	...
	private String[] helpItems = {"Main","Target Word","Other Words","Positioning"};
